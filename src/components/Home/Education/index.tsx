          ...
          <Flex direction="column" gap="xs" mt={10}>
            ...
            <List>
              <List.Item icon={<IconCertificate size={16} />}>
                <Text size="md">
                  Software Development with Scrum Certificate
                </Text>
                <Text size="sm" c="gray">
            ...
            <List>
              <List.Item icon={<IconBriefcase size={16} />}>
                ...
                <Text size="sm" c="gray">
                  Lead of design team: Design media publications and other
                  products for events such as the CSE Job Fair, the Green Summer
                  Volunteer Campaign, etc{" "}
                  <Link href={""}>Explore my Gallery</Link>
                </Text>
              </List.Item>
              <List.Item icon={<IconBriefcase size={16} />}>
                <Text size="md">
                  Spring Volunteer Campaign of CSE Faculty 2020 - 2021
                </Text>
                <Text size="sm" c="gray">
